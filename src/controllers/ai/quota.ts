  ...
  try {
    ...
    res.json({
      ...
      stats: {
        ...
        status: {
          healthy: Math.max(stats.percentages.requests, stats.percentages.tokens, stats.percentages.cost) < 80,
          warning: Math.max(stats.percentages.requests, stats.percentages.tokens, stats.percentages.cost) >= 80,
          critical: Math.max(stats.percentages.requests, stats.percentages.tokens, stats.percentages.cost) >= 95
        },
        remainingTime: {
