...
process.env.ULTRAPRODUCT = process.env.ULTRAPRODUCT || "ultra_test_product";
...
process.env.ULTRAMONTHLY = process.env.ULTRAMONTHLY || "pri_test_ultra_monthly";
process.env.ULTRAYEARLY = process.env.ULTRAYEARLY || "pri_test_ultra_yearly";
