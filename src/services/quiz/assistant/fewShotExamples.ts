...
export const COLLEGE_6EME_5EME_EXAMPLES: FewShotExample[] = [
  {
    ...
    questions_generated: [
      {
        question:
          "Quel élément nutritif essentiel pour les os trouve-t-on en grande quantité dans le lait ?",
        type: "QCM",
        difficulte: "facile",
      ...
      {
        question:
          "Explique pourquoi le calcium est important pour le développement des os chez les enfants et adolescents.",
        type: "OPEN_QUESTION",
        difficulte: "moyen",
      ...
      {
        question:
          "Marie ne peut pas boire de lait car elle est intolérante au lactose. Propose-lui 3 autres aliments riches en calcium qu'elle pourrait consommer.",
        type: "OPEN_QUESTION",
        difficulte: "moyen",
      ...
      {
        question:
          "Vrai ou faux : Tous les produits laitiers contiennent la même quantité de calcium.",
        type: "TRUE_FALSE",
        difficulte: "moyen",
        bloom_level: "compréhension",
        reponse_attendue:
          "Faux - Les quantités varient selon les produits (fromage > lait > yaourt)",
      },
    ],
  },
  {
    ...
    questions_generated: [
      {
        ...
        options: [
          ...
          {
            id: "B",
            text: "Un homme qui prête serment de fidélité à un seigneur",
            isCorrect: true,
          },
      ...
      {
        question:
          "Si tu étais un seigneur au Moyen Âge, quels seraient tes droits et tes devoirs envers tes vassaux ?",
        type: "OPEN_QUESTION",
...
export const COLLEGE_4EME_3EME_EXAMPLES: FewShotExample[] = [
  {
    ...
    concept:
      "L'intensité du courant électrique se mesure en ampères (A) avec un ampèremètre branché en série",
    questions_generated: [
      {
      ...
      {
        question:
          "Explique la différence entre un branchement en série et un branchement en parallèle dans un circuit électrique.",
        type: "OPEN_QUESTION",
        difficulte: "moyen",
        bloom_level: "compréhension",
        criteres_evaluation: [
      ...
      {
        question:
          "Dans un circuit avec 3 lampes en série alimentées par une pile de 4,5V, chaque lampe reçoit la même tension. Vrai ou faux ?",
        type: "TRUE_FALSE",
        difficulte: "moyen",
        bloom_level: "application",
        reponse_attendue:
          "Faux - En série, la tension se répartit entre les composants (environ 1,5V par lampe)",
      },
      {
        question:
          "Tu veux mesurer l'intensité du courant qui traverse une lampe dans un circuit. Dessine le schéma du circuit en incluant l'ampèremètre correctement branché.",
        type: "OPEN_QUESTION",
        difficulte: "difficile",
        bloom_level: "application",
        criteres_evaluation: [
  ...
  },
  {
    ...
    questions_generated: [
      {
        question:
          "Dans un triangle ABC rectangle en B, avec AB = 3 cm et BC = 4 cm, quelle est la longueur de l'hypoténuse AC ?",
        type: "QCM",
        difficulte: "moyen",
        bloom_level: "application",
        options: [
      ...
      {
        question:
          "Énonce le théorème de Pythagore et explique dans quel type de triangle il s'applique.",
        type: "OPEN_QUESTION",
        difficulte: "facile",
        bloom_level: "mémorisation",
        criteres_evaluation: [
      ...
      {
        question:
          "Un triangle DEF a les côtés suivants : DE = 6 cm, EF = 8 cm, DF = 10 cm. Prouve que ce triangle est rectangle.",
        type: "OPEN_QUESTION",
        difficulte: "difficile",
        bloom_level: "analyse",
        criteres_evaluation: [
...
export const LYCEE_EXAMPLES: FewShotExample[] = [
  {
    ...
    questions_generated: [
      ...
      {
        question:
          "Soit f(x) = (e^x - 1)/x. Déterminez lim(x→0) f(x) en utilisant le taux d'accroissement de la fonction exponentielle. Justifiez votre démarche.",
        type: "OPEN_QUESTION",
        difficulte: "difficile",
        bloom_level: "analyse",
        criteres_evaluation: [
      ...
      {
        question:
          "Soit f continue sur [0,3] avec f(0) = -2 et f(3) = 5. D'après le théorème des valeurs intermédiaires, que peut-on affirmer ?",
        type: "QCM",
        difficulte: "moyen",
        bloom_level: "compréhension",
        options: [
  ...
  },
  {
    ...
    questions_generated: [
      ...
      {
        question:
          "Soit f(x) = 1/(1+x²). Exprimez l'aire sous la courbe de f entre 0 et 1 sous forme d'intégrale, puis calculez-la sachant que la primitive de f est arctan(x).",
        type: "OPEN_QUESTION",
        difficulte: "difficile",
        bloom_level: "application",
        criteres_evaluation: [
      ...
      {
        question:
          "Une fonction f positive sur [a,b] a pour intégrale ∫ₐᵇ f(x)dx = 0. Que peut-on conclure ?",
        type: "QCM",
        difficulte: "difficile",
        bloom_level: "analyse",
        options: [
  ...
  },
  {
    ...
    questions_generated: [
      {
        question:
          "Soit (uₙ) définie par u₀ = 1 et uₙ₊₁ = (uₙ + 2)/2 pour tout n ∈ ℕ. Démontrez par récurrence que pour tout n ∈ ℕ, uₙ ≤ 2.",
        type: "OPEN_QUESTION",
        difficulte: "difficile",
        bloom_level: "application",
        criteres_evaluation: [
      ...
      {
        question:
          "Soit (vₙ) une suite géométrique de raison q = 0,8 et v₀ = 100. Quelle est la limite de vₙ quand n tend vers +∞ ?",
        type: "QCM",
        difficulte: "facile",
        bloom_level: "application",
        options: [
      ...
      {
        question:
          "Étudiez la convergence de la suite (wₙ) définie par w₀ = 3 et wₙ₊₁ = √(2wₙ + 3). Déterminez sa limite si elle existe.",
        type: "OPEN_QUESTION",
  ...
  },
  {
    ...
    sujet: "SVT - Génétique",
    concept:
      "Les mutations génétiques peuvent être transmises à la descendance si elles touchent les cellules germinales",
    questions_generated: [
      {
        question:
        ...
        options: [
          {
            id: "A",
            text: "Les mutations somatiques touchent les cellules du corps, les germinales touchent les gamètes",
            isCorrect: true,
          },
          {
            id: "B",
            text: "Les mutations somatiques sont toujours bénéfiques, les germinales sont néfastes",
            isCorrect: false,
          },
          {
            id: "C",
            text: "Les mutations somatiques sont réversibles, les germinales sont permanentes",
            isCorrect: false,
          },
          {
            id: "D",
            text: "Les mutations somatiques se produisent pendant l'embryogenèse uniquement",
            isCorrect: false,
          },
        ],
      },
      {
        question:
          "Expliquez pourquoi une mutation dans une cellule de la peau (mélanocyte) ne sera pas transmise aux enfants d'un individu, tandis qu'une mutation dans un ovule le sera.",
        type: "OPEN_QUESTION",
        difficulte: "moyen",
        bloom_level: "compréhension",
        criteres_evaluation: [
      ...
      {
        question:
          "Analysez les conséquences évolutives des mutations germinales par rapport aux mutations somatiques sur une population.",
        type: "OPEN_QUESTION",
        difficulte: "difficile",
        bloom_level: "analyse",
        criteres_evaluation: [
  ...
  },
  {
    ...
    concept:
      "Descartes affirme 'Je pense donc je suis' (Cogito) comme fondement indubitable de la connaissance",
    questions_generated: [
      {
        question:
          "Selon Descartes, pourquoi le Cogito ('Je pense donc je suis') constitue-t-il une vérité indubitable ?",
        type: "QCM",
        difficulte: "moyen",
        bloom_level: "compréhension",
        options: [
          {
            id: "A",
            text: "Parce que l'acte de douter prouve l'existence du sujet pensant",
            isCorrect: true,
          },
          { id: "B", text: "Parce que c'est une vérité révélée par Dieu", isCorrect: false },
          {
            id: "C",
            text: "Parce que c'est une évidence partagée par tous les humains",
            isCorrect: false,
          },
          {
            id: "D",
            text: "Parce que c'est une vérité démontrée mathématiquement",
            isCorrect: false,
          },
        ],
      },
      {
        question:
          "Développez le raisonnement du doute méthodique cartésien qui conduit au Cogito. Quelles sont les étapes de ce processus ?",
        type: "OPEN_QUESTION",
        difficulte: "difficile",
        bloom_level: "compréhension",
        criteres_evaluation: [
      ...
      {
        question:
          "Discutez de manière critique : le Cogito cartésien est-il vraiment indubitable ? Présentez au moins une objection philosophique.",
        type: "OPEN_QUESTION",
        difficulte: "très difficile",
...
export const SUPERIEUR_EXAMPLES: FewShotExample[] = [
  {
    ...
    concept:
      "La régulation de la pression artérielle implique le système rénine-angiotensine-aldostérone (SRAA)",
    questions_generated: [
      {
        question:
          "Décrivez la cascade enzymatique du système rénine-angiotensine-aldostérone (SRAA) depuis la sécrétion de rénine jusqu'à l'effet sur la pression artérielle.",
        type: "OPEN_QUESTION",
        difficulte: "difficile",
        bloom_level: "compréhension",
        criteres_evaluation: [
      ...
      {
        question:
          "Cas clinique : Un patient hypertendu présente une hypokaliémie, une alcalose métabolique et une rénine plasmatique supprimée. Quel diagnostic suspectez-vous et quels examens complémentaires prescrire ?",
        type: "OPEN_QUESTION",
        difficulte: "très difficile",
        bloom_level: "évaluation",
        criteres_evaluation: [
      ...
      {
        question:
          "Expliquez le mécanisme d'action des IEC (inhibiteurs de l'enzyme de conversion) et leurs effets secondaires caractéristiques.",
        type: "OPEN_QUESTION",
        difficulte: "moyen",
        bloom_level: "compréhension",
        criteres_evaluation: [
  ...
  },
  {
    ...
    concept:
      "L'algorithme de tri rapide (QuickSort) a une complexité moyenne O(n log n) mais O(n²) dans le pire cas",
    questions_generated: [
      {
        question:
          "Quelle est la complexité temporelle moyenne et dans le pire cas de l'algorithme QuickSort ? Expliquez pourquoi ces complexités diffèrent.",
        type: "OPEN_QUESTION",
        difficulte: "moyen",
        bloom_level: "compréhension",
        criteres_evaluation: [
      ...
      {
        question:
          "Comparez QuickSort et MergeSort en termes de complexité temporelle, spatiale et de stabilité. Dans quels contextes pratiques privilégier l'un ou l'autre ?",
        type: "OPEN_QUESTION",
        difficulte: "difficile",
        bloom_level: "analyse",
        criteres_evaluation: [
      ...
      {
        question:
          "Démontrez formellement que la complexité moyenne de QuickSort est O(n log n) en utilisant l'analyse probabiliste.",
        type: "OPEN_QUESTION",
        difficulte: "très difficile",
        bloom_level: "évaluation",
        criteres_evaluation: [
 ...
 */
export function getFewShotExamplesByLevel(level: string, collegeGrade?: string): FewShotExample[] {
  ...
  if (level === "COLLEGE") {
    if (collegeGrade === "SIXIEME" || collegeGrade === "CINQUIEME") {
      logger.log(
        `📚 [FEW-SHOT] Exemples sélectionnés: COLLEGE_6EME_5EME (${COLLEGE_6EME_5EME_EXAMPLES.length} exemples)`,
      );
      return COLLEGE_6EME_5EME_EXAMPLES;
    }
    if (collegeGrade === "QUATRIEME" || collegeGrade === "TROISIEME") {
      logger.log(
        `📚 [FEW-SHOT] Exemples sélectionnés: COLLEGE_4EME_3EME (${COLLEGE_4EME_3EME_EXAMPLES.length} exemples)`,
      );
  ...
  if (level === "ETUDES_SUPERIEURES") {
    logger.log(
      `📚 [FEW-SHOT] Exemples sélectionnés: SUPERIEUR (${SUPERIEUR_EXAMPLES.length} exemples)`,
    );
 ...
 */
export function getFewShotPrompt(level: string, collegeGrade?: string): string {
