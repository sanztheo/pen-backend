 ...
 *   infisical run --env=prod --path=/Backend -- npx tsx scripts/beta-reopen.ts --test sanztheo8@gmail.com
 *
...
const EXCLUDED_EMAILS = new Set(["sanztheopro@gmail.com", "sanztheo8@gmail.com"]);
